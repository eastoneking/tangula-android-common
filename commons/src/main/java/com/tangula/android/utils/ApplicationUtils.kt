...
class ApplicationUtils {
    ...
    companion object {
        ...
        val KEY_UNIQUE_ID_SP_NAME = "KEY_UNIQUE_ID_SP_NAME"
        val KEY_UNIQUE_ID_IN_SP = "KEY_UNIQUE_ID_IN_SP"
        ...
        fun fetchUniqueId(ctx: Context): String {
            ...
            var id_string = """${getAndroidId(ctx)}|BOARD:${Build.BOARD}|BRAND:${Build.BRAND}
